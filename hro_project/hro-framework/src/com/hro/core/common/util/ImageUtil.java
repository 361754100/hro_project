...
public class ImageUtil {
     ...
     * @throws IOException 
     */
    public BufferedImage thumbnailImage(File imgFile, int w, int h, String prevfix, boolean force) throws Exception{
        if(imgFile.exists()){
...
//            ImageIO.write(bi, suffix, new File(p.substring(0,p.lastIndexOf(File.separator)) + File.separator + prevfix +imgFile.getName()));
    ...
    public BufferedImage thumbnailImage(String imagePath, int w, int h, String prevfix, boolean force) throws Exception{
        File imgFile = new File(imagePath);
        return thumbnailImage(imgFile, w, h, prevfix, force);
    }
    
    public BufferedImage thumbnailImage(String imagePath, int w, int h, boolean force) throws Exception{
    	return thumbnailImage(imagePath, w, h, DEFAULT_PREVFIX, force);
    }
    
    public BufferedImage thumbnailImage(String imagePath, int w, int h) throws Exception{
